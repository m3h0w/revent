...
function SlickArrow({ className, onClick, control }) {
  return (
    <Button variant='text' className={className} sx={styles.paginationButton} onClick={onClick}>
      {control === 'prev' ? <BsArrowLeft size='32px' /> : <BsArrowRight size='32px' />}
    </Button>
  );
}
...
const Clients = () => {
  ...
  return (
    <Box id='purpose' as='section' sx={styles.section}>
      <Container>
        <SectionHeading slogan='Purpose' title='Borderland.Land ' />
